...
const MovieCard = ({ id, title, poster_path, release_date, vote_average }) => {
    return (
        <div className='p-3 w-52 max-w-sm bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700'>
            <div>
                <img src={`https://image.tmdb.org/t/p/w500${poster_path}`} alt={poster_path} />
            </div>
            <div>
                {/* <p className='text-l font-bold text-white'>{title}</p>   */}
